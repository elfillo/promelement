<?php
	...
	function enqueue_script()
	{
		...
		wp_enqueue_script('ip', get_template_directory_uri() . '/js/ip.js', array('jquery'), null, true);
	...
	function prom_widgets_init()
	{
		...
		register_sidebar(
			array(
				...
				'id' => 'sidebar-1',
				'description' => __('Выводит виджеты в сайдбар.', 'prom'),
	...
	require_once('parts/admin/shortcodes/breadcrumbs.php');
